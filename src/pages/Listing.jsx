          ...
          <div className="w-full ">
            ...
            <div className="mt-6">
              <button onClick={()=> setContactLandlord(true)}
                className="px-6 py-3 bg-blue-500 text-white font-medium text-small uppercase 
                            rounded shadow-md hover:bg-blue-600 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg
