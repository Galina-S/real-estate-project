...
export default function EditListing() {
   ...
   async function onSubmit (e) {
        ...
        if (+discountedPrice >= +regularPrice) {  //+ to convert a string to a number
            setLoading(false);
        ...
        const docRef = doc(db, "listings", params.listingId);  //fetch the current listing and fill it with a formDataCopy
        ...
        <form onSubmit={onSubmit}>
            ...
            <div className='flex'> 
                <button type = "button" 
                        ...
                        shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150 ease-in-out w-full 
                        ${type==="rent" 
                            ? "bg-white text-black"
            ...
            <input type="text" id='address' value={address} onChange={onChange} placeholder="Address" maxLength="32" minLength={10} required
            ...
            <div className='mb-6'>
                ...
                <p className='text-gray-600 '>The first imag will be cover (max 6)</p>
