...
export default function SignIn() {
  ...
  return (
    <section>
      <h1 className="font-serif text-3xl text-center mt-6 font-bold">Sign In</h1>
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-[50%] lg:w-[40%] lg:ml-20">
          <form onSubmit={onSubmit}>
            ...
            transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800' type="submit">Sign in
            </button>
