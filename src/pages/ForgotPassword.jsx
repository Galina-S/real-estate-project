...
export default function ForgotPassword() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      toast.error("Couldn't send an email to reset the password ")
    }
  ...
  return (
    <section>
      <h1 className="font-serif text-3xl text-center mt-6 font-bold">Forgot password</h1>
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        ...
        <div className="font-serif w-full md:w-[50%] lg:w-[40%] lg:ml-20">
          <form onSubmit={onSubmit}>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              ...
              <p>
                <Link to="/sign-in"
                className="text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out ml-1">Sign in instead</Link>
              </p>
            </div>
            ...
            transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800' type="submit">Send reset password
            </button>
