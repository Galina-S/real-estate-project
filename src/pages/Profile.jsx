  ...
  return (
   ...
   <section className="font-serif max-w-6xl mx-auto flex justify-center items-center flex-col">
      ...
      <div className='w-full md:w-[50%] mt-6 px-3'>
        <form>
          {/*name input */}
          <input type="text" id="name" value={name} disabled className='w-full mb-6 px-4 py-2 text-xl text-gray-700 
          ...
          <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
            <p className='flex items-center'>Do you want to change your name?
              <span className='font-serif text-red-600 hover:text-red-700 transition ease-in-out duration-200 ml-1 cursor-pointer'>Edit</span>
            </p>
